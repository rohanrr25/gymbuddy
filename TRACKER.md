...
| 7b | Rest timer | Rest between sets and between exercises: set per exercise in the routine, or our recommendation when not set. User request 2026-09-21. | ⬜ scoping |
