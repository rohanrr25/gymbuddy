...
**Left open:** the calories estimate (feedback 5) is still an unanswered question to the user. Neon's free plan sleeping is the remaining slowness. Feature 14 (the UI polish pass) and social are still parked.
